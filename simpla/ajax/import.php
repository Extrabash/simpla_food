...
{	
	...
	private $columns_names = array(
			...
			'package_weight'=>		array('package_weight', 'Вес в пачке'),
			'minimum_amount'=>		array('minimum_amount', 'Мин. заказ'),
			'items_per_package'=>	array('items_per_package', 'Кратно'),
	...
	private function import_item($item)
	{
		...
		if(isset($item['package_weight']))
			$variant['package_weight'] = trim($item['package_weight']);

		if(isset($item['minimum_amount']))
			$variant['minimum_amount'] = trim($item['minimum_amount']);

		if(isset($item['items_per_package']))
			$variant['items_per_package'] = trim($item['items_per_package']);
