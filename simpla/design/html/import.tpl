	...
	{else}
		...
		<p>
			...
			<ul>
				...
				<li><label>Вес в пачке</label> например 0.45 для расчета цены за кг.</li>
				<li><label>Мин. заказ</label> минимальный заказ</li>
				<li><label>Кратно</label> кратность заказа, например упаковки поштучно по 5</li>
