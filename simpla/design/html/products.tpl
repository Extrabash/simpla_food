                ...
                {foreach $products as $product}
                    <div class="{if !$product->visible}invisible{/if} {if $product->featured}featured{/if} row">
                        ...
                        <div class="name product_name cell">
                            <a
                                href="{url module=ProductAdmin id=$product->id return=$smarty.server.REQUEST_URI}">{$product->name|escape}</a>
                        </div>
                        ...
                        <div class="oreh_row variants_block">
                            <ul class="header">
                                ...
                                <li class="variant_sku">Вес в пачке</li>
                                <li class="variant_sku">Мин. заказ</li>
                                <li class="variant_sku">Кратно</li>
                                ...
                                {foreach $product->variants as $variant}
                                    <ul>
                                        <li class="variant_sku">
                                            <input name="sku[{$variant->id}]" type="text" value="{$variant->sku|escape}" />
                                        </li>
                                        <li class="variant_price"> 
											<input name="price[{$variant->id}]" type="text" value="{$variant->price|escape}" />
										</li>
                                        <li class="variant_discount"> 
											<input name="compare_price[{$variant->id}]" type="text" value="{$variant->compare_price|escape}" />
										</li>
                                        <li class="variant_name">
                                            <input name="name[{$variant->id}]" type="" value="{$variant->name|escape}" />
                                        </li>
                                        <li class="variant_sku">
                                            <input name="package_weight[{$variant->id}]" type="text" value="{$variant->package_weight|escape}" />
                                        </li>
                                        <li class="variant_sku">
                                            <input name="minimum_amount[{$variant->id}]" type="text" value="{$variant->minimum_amount|escape}" />
                                        </li>
                                        <li class="variant_sku">
                                            <input name="items_per_package[{$variant->id}]" type="text" value="{$variant->items_per_package|escape}" />
                                        </li>

                                        <li class="variant_amount"> 
											<input name="stock[{$variant->id}]" type="text" value="{if $variant->infinity || $variant->stock == ''}∞{else}{$variant->stock|escape}{/if}" />{$settings->units}
                                        </li>
                                    </ul>
                                {/foreach}
                            </div>
